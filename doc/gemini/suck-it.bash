...
# Download the English version of the main documentation page, preserving MIME types, adjusting extensions, and removing special characters from filenames
wget -r -np -nH --cut-dirs=3 -E -P gemini-api-docs --restrict-file-names=windows https://ai.google.dev/gemini-api/docs/en/
